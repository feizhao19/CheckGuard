...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 False \
    --fp16 True \
    --output_dir /home/larry5/project/LLaVA-1.6-ft/scripts_peft/mistral/lora/llava-lora-mistral-r128a256/subimage/amount/llava-lora-mistral-r128a256-10BS-model \
    --num_train_epochs 1 \
